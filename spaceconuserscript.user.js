...
\
    ...
    if (savedState) \{\
        try \{\
            ...
            console.log("\uc0\u55357 \u56580  Userscripts App: Loaded saved state", scriptState);\
        \} catch (e) \{\
            console.error("\uc0\u10060  Userscripts App: Failed to parse script state", e);\
        \}\
    \}\
\
...
\
        ...
        if (scrolledDistance >= totalHeight - 2) \{\
            console.log("\uc0\u11015 \u65039  Reached bottom of page. Refreshing...");\
            resetAndRefresh();\
        \}\
    \}, STEP_INTERVAL);\
\
    ...
    const refreshTimeout = setTimeout(() => \{\
        console.log("\uc0\u9201 \u65039  900 seconds elapsed. Refreshing...");\
        resetAndRefresh();\
    \}, REFRESH_INTERVAL);\
\})();\
}
